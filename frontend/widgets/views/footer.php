    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-md-12">
                ...
                <br>
                <div class="pt-30px">
                            <span><i class="feather icon-feather-map-pin text-white me-10px"></i> New Uzbekistan University, U.C.A building, Room 103
...
<div class="scroll-progress d-none d-xxl-block">
    <a href="<?=\yii\helpers\Url::home()?>#" class="scroll-top" aria-label="scroll">
